...
- The **active DP-to-HDMI 2.1 converter is the correct fix**, now confirmed in practice. The GPU emits plain DisplayPort, which has no HDMI Forum entanglement. DSC is load-bearing, not marketing: 4K120 RGB 10-bit needs ~35.6 Gbps uncompressed against HBR3's ~25.9 Gbps effective; the link negotiated 16 bpp DSC, which is ~19 Gbps. (An earlier estimate here said ~12 Gbps — the measured figure is 16 bpp.) A **passive** DP++ adapter would land back at 4K60.
